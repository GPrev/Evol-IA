...
namespace PokeMath
{
    class G4Rules : Rules
    {
        ...
        const int[,] typeChart = new int[,] { {  4,  4,  4,  4,  4,  2,  4,  0,  2,  4,  4,  4,  4,  4,  4,  4,  4,  4 },   // No
        ...
        float getTypeModifier(Type attackType, Type defType1, Type defType2 = Type.NONE)
        {
        ...
        int damageFormula(Pokemon attP, Pokemon defP, Move m)
        {
            int att = attP.Attack;
            if (m.Special)
                att = attP.SpAttack;
